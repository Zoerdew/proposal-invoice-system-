...
export default async function OnboardingPage({
  ...
  return (
    <div className="max-w-2xl mx-auto w-full px-8 py-12">
      <div className="hero-ink mb-10 p-10">
        <p className="text-sm tracking-wide uppercase text-[#FDE047] font-heading font-[800] mb-2">
          {client.name} — Welcome
        </p>
      ...
      <div className="card-brutal-yellow mb-14 p-6">
        <p className="text-sm tracking-wide uppercase text-[#0a0608]/70 font-heading font-[800] mb-6">

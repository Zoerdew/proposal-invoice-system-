...
export default function ConvertToProposal({ leadId }: { leadId: string }) {
  ...
  return (
    <div className="admin-card p-6">
      ...
      <p className="mb-4 text-sm text-[#0a0608]/60">
        Creates a draft proposal pre-filled with this lead&apos;s name and email — offer, line
        items, and contract terms still need filling in.
      </p>
